...
environment = {
    ...
    "values": [
        {"key": "base_url", "value": "http://localhost:8000", "type": "default",
         "enabled": True},
        {"key": "consultant_email", "value": "sarah.jenkins@jenkinslaw.com",
         "type": "default", "enabled": True},
        {"key": "consultant_password", "value": "Str0ng!Pass1", "type": "secret",
         "enabled": True},
        {"key": "admin_email", "value": "admin@webimove.com", "type": "default",
         "enabled": True},
        {"key": "admin_password", "value": "StrongPass1!", "type": "secret",
         "enabled": True},
    ],
