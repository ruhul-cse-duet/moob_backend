...
CATALOGUE: Dict[str, Dict[str, Any]] = {
    ...
    "email.client_invite.subject": {"en": "{org} invited you to WebImove", "pt": "A {org} convidou você para o WebImove", "es": "{org} le invitó a WebImove"},
    "email.client_invite.title": {"en": "{org} created your client workspace", "pt": "A {org} criou seu espaço de cliente", "es": "{org} creó su espacio de cliente"},
    "email.client_invite.body_with_consultant": {"en": "Hi {name}, your consultant {consultant} at {org} created your workspace. Track your request, upload documents and follow every stage from the WebImove app.", "pt": "Olá {name}, seu consultor {consultant} da {org} criou seu espaço. Acompanhe sua solicitação, envie documentos e siga cada etapa a partir da aplicativo WebImove.", "es": "Hola {name}, su consultor {consultant} de {org} creó su espacio. Siga su solicitud, suba documentos y siga cada etapa desde la aplicación WebImove."},
    "email.client_invite.body": {"en": "Hi {name}, {org} created your workspace. Track your request, upload documents and follow every stage from the WebImove app.", "pt": "Olá {name}, a {org} criou seu espaço. Acompanhe sua solicitação, envie documentos e siga cada etapa a partir da aplicativo WebImove.", "es": "Hola {name}, {org} creó su espacio. Siga su solicitud, suba documentos y siga cada etapa desde la aplicación WebImove."},
    "email.client_invite.cta": {"en": "Get started", "pt": "Começar", "es": "Comenzar"},
    "email.partner_invite.subject": {"en": "{org} invited you to WebImove", "pt": "A {org} convidou você para o WebImove", "es": "{org} le invitó a WebImove"},
    "email.partner_invite.title": {"en": "You have been invited to {org}", "pt": "Foi convidado para a {org}", "es": "Ha sido invitado a {org}"},
    "email.partner_invite.body_with_inviter": {"en": "Hi {name}, {inviter} at {org} has added you as {role}. Click below to set a password and activate your account.", "pt": "Olá {name}, {inviter} da {org} adicionou você como {role}. Clique abaixo para definir uma senha e ativar sua conta.", "es": "Hola {name}, {inviter} de {org} le agregó como {role}. Haga clic abajo para establecer una contraseña y activar su cuenta."},
    "email.partner_invite.body": {"en": "Hi {name}, {org} has added you as {role}. Click below to set a password and activate your account.", "pt": "Olá {name}, a {org} adicionou você como {role}. Clique abaixo para definir uma senha e ativar sua conta.", "es": "Hola {name}, {org} le agregó como {role}. Haga clic abajo para establecer una contraseña y activar su cuenta."},
    "email.partner_invite.cta": {"en": "Set my password", "pt": "Definir a minha senha", "es": "Establecer mi contraseña"},
    ...
    "status.pending_approval": {"en": "Awaiting consultant approval",
                                "pt": "Aguardando aprovação do consultor",
    ...
    "status.processing": {"en": "Processing", "pt": "Em processamento",
                          "es": "En proceso"},
    "status.new": {"en": "New request", "pt": "Nova solicitação", "es": "Nueva solicitud"},
    "status.waiting_for_client": {
        "en": "Waiting for client", "pt": "Aguardando o cliente",
    ...
    "document_status.upload_needed": {
        "en": "Waiting for upload", "pt": "Aguardando envio",
        "es": "Esperando la subida"},
    "document_status.with_consultant": {
        "en": "With your consultant", "pt": "Com seu consultor",
        "es": "Con su consultor"},
    ...
    # ---- request timeline ----
    "step.submitted": {"en": "Request submitted", "pt": "Solicitação enviada",
    ...
    "banner.client_request_queue": {
        ...
        "pt": {"one": "{count} solicitação de cliente pronta para análise",
               "other": "{count} solicitações de clientes prontas para análise"},
        "es": {"one": "{count} solicitud de cliente lista para revisar",
               "other": "{count} solicitudes de clientes listas para revisar"},
    },
    "cta.review_requests": {"en": "Review requests", "pt": "Analisar solicitações",
    ...
    "role.client.description": {
        ...
        "pt": "Acompanhe sua solicitação, documentos e mensagens",
    ...
    "stage.new_request": {"en": 'New request', "pt": 'Nova solicitação', "es": 'Nueva solicitud'},
    ...
    "consent.terms_of_service.description": {"en": 'The agreement that governs your use of WebImove.', "pt": 'O acordo que rege sua utilização do WebImove.', "es": 'El acuerdo que rige su uso de WebImove.'},
    "consent.privacy_policy": {"en": 'Privacy Policy', "pt": 'Política de Privacidade', "es": 'Política de Privacidad'},
    "consent.privacy_policy.description": {"en": 'How your personal data is collected, stored and erased.', "pt": 'Como seus dados pessoais são recolhidos, guardados e apagados.', "es": 'Cómo se recopilan, almacenan y eliminan sus datos personales.'},
    "consent.data_processing": {"en": 'Data processing', "pt": 'Tratamento de dados', "es": 'Procesamiento de datos'},
    "consent.data_processing.description": {"en": 'Lets your consultant process your documents to prepare your case.', "pt": 'Permite que seu consultor trate seus documentos para preparar o processo.', "es": 'Permite a su consultor procesar sus documentos para preparar su caso.'},
    ...
    "consent.document_sharing_with_partners.description": {"en": 'Allows approved partners — translators, notaries — to see the files they need for their task.', "pt": 'Permite que parceiros aprovados — tradutores, notários — vejam apenas os arquivos de que precisam.', "es": 'Permite que los socios aprobados — traductores, notarios — vean solo los archivos que necesitan.'},
    ...
    "consent.email_notifications.description": {"en": 'Updates about your case by email.', "pt": 'Novidades sobre seu processo por email.', "es": 'Novedades sobre su caso por correo electrónico.'},
    "consent.whatsapp_notifications": {"en": 'WhatsApp notifications', "pt": 'Notificações por WhatsApp', "es": 'Notificaciones por WhatsApp'},
    "consent.whatsapp_notifications.description": {"en": 'Updates about your case on WhatsApp.', "pt": 'Novidades sobre seu processo no WhatsApp.', "es": 'Novedades sobre su caso por WhatsApp.'},
    "consent.marketing_emails": {"en": 'Marketing emails', "pt": 'Emails de marketing', "es": 'Correos de marketing'},
    "consent.marketing_emails.description": {"en": 'Occasional product news. Never required, and never affects your case.', "pt": 'Novidades ocasionais do produto. Nunca obrigatório, e nunca afeta seu processo.', "es": 'Novedades ocasionales del producto. Nunca es obligatorio y nunca afecta a su caso.'},


    # ---- Super Admin panel ----
    "tenant_status.awaiting_approval": {"en": 'Awaiting approval', "pt": 'Aguardando aprovação', "es": 'Esperando aprobación'},
    ...
    "role_card.clients.description": {"en": 'Submit requests, upload documents.', "pt": 'Enviam solicitações e carregam documentos.', "es": 'Envían solicitudes y suben documentos.'},
    ...
    "signed_up.days_ago": {"en": {'one': 'Signed up {count} day ago', 'other': 'Signed up {count} days ago'}, "pt": {'one': 'Cadastrou-se há {count} dia', 'other': 'Cadastrou-se há {count} dias'}, "es": {'one': 'Se registró hace {count} día', 'other': 'Se registró hace {count} días'}},
    ...
    "settings_section.limits_contact": {"en": 'Limits & contact', "pt": 'Limites e contato', "es": 'Límites y contacto'},
    "setting.consultants_can_create_organization": {"en": 'Consultants can create their own organization', "pt": 'Os consultores podem criar sua própria organização', "es": 'Los consultores pueden crear su propia organización'},
    ...
    "setting.document_checks_enabled.description": {"en": 'Runs document OCR and automated review on uploads.', "pt": 'Executa OCR e revisão automática nos arquivos carregados.', "es": 'Ejecuta OCR y revisión automática en los archivos subidos.'},
    ...
    "setting.max_document_size_mb.description": {"en": 'Uploaded files larger than this are rejected.', "pt": 'Arquivos maiores do que isto são rejeitados.', "es": 'Los archivos más grandes que esto se rechazan.'},
    ...
    "setting.document_retention_months.description": {"en": 'Controls how long closed-case files stay available.', "pt": 'Define durante quanto tempo os arquivos de processos fechados ficam disponíveis.', "es": 'Define cuánto tiempo siguen disponibles los archivos de casos cerrados.'},
    ...
    # ---- notifications ----
    "notify.request_submitted": {"en": '{client} submitted a request', "pt": '{client} enviou uma solicitação', "es": '{client} envió una solicitud'},
    "notify.client_joined": {"en": '{client} joined and raised a request', "pt": '{client} registou-se e criou uma solicitação', "es": '{client} se registró y creó una solicitud'},
    ...
    "notify.request_approved": {"en": 'Your request was approved', "pt": 'Sua solicitação foi aprovada', "es": 'Su solicitud fue aprobada'},
    "notify.request_declined": {"en": 'Your request was not taken forward', "pt": 'Seu solicitação não avançou', "es": 'Su solicitud no siguió adelante'},
    ...
    "notify.request_withdrawn": {"en": '{client} withdrew a request', "pt": '{client} retirou uma solicitação', "es": '{client} retiró una solicitud'},
    "notify.request_removed": {"en": 'A request was removed', "pt": 'Um solicitação foi removido', "es": 'Una solicitud fue eliminada'},
    "area.immigration": {"en": 'Immigration', "pt": 'Imigração', "es": 'Extranjería'},
    "area.immigration.description": {"en": 'Visas, residence permits, citizenship and related matters.', "pt": 'Vistos, autorizações de residência, nacionalidade e assuntos relacionados.', "es": 'Visados, permisos de residencia, nacionalidad y asuntos relacionados.'},
    "area.labour": {"en": 'Labour', "pt": 'Laboral', "es": 'Laboral'},
    "area.labour.description": {"en": 'Employment contracts, dismissals and workplace disputes.', "pt": 'Contratos de trabalho, despedimentos e conflitos laborais.', "es": 'Contratos de trabajo, despidos y conflictos laborales.'},
    "area.civil": {"en": 'Civil', "pt": 'Civil', "es": 'Civil'},
    ...
    "activity.approved_request": {"en": "Approved a request", "pt": "Aprovou uma solicitação", "es": "Aprobó una solicitud"},
    "activity.assigned_task": {"en": "Assigned a partner task", "pt": "Atribuiu uma tarefa a um parceiro", "es": "Asignó una tarea a un socio"},
    "activity.declined_partner_task": {"en": "Declined a partner task", "pt": "Recusou uma tarefa de parceiro", "es": "Rechazó una tarea de socio"},
    "activity.completed_partner_task": {"en": "Completed a partner task", "pt": "Concluiu uma tarefa de parceiro", "es": "Completó una tarea de socio"},
    "activity.delivered_partner_task": {"en": "Delivered a partner task", "pt": "Entregou uma tarefa de parceiro", "es": "Entregó una tarea de socio"},
    "activity.completed_consultation": {"en": "Completed the consultation for", "pt": "Concluiu a consulta de", "es": "Completó la consulta de"},
    "activity.declined_request": {"en": "Declined a request", "pt": "Recusou uma solicitação", "es": "Rechazó una solicitud"},
    "activity.opened_case": {"en": "Opened a case for", "pt": "Abriu um processo para", "es": "Abrió un caso para"},
    "activity.opened_request": {"en": "Opened a request", "pt": "Abriu uma solicitação", "es": "Abrió una solicitud"},
    "activity.removed_document_request": {"en": "Withdrew a document request", "pt": "Retirou uma solicitação de documento", "es": "Retiró una solicitud de documento"},
    ...
    "activity.submitted_request": {"en": "Submitted a request", "pt": "Enviou uma solicitação", "es": "Envió una solicitud"},
    "activity.uploaded": {"en": "Uploaded a document", "pt": "Enviou um documento", "es": "Subió un documento"},
    "activity.withdrew_request": {"en": "Withdrew a request", "pt": "Retirou uma solicitação", "es": "Retiró una solicitud"},
    "activity.authority_request_logged": {"en": "Logged a request from the authority", "pt": "Registou uma solicitação da autoridade", "es": "Registró una solicitud de la autoridad"},
    ...
    "notify.documents_requested": {"en": 'Your consultant requested documents', "pt": 'Seu consultor pediu documentos', "es": 'Su consultor solicitó documentos'},
    "notify.case_opened": {"en": 'Your case has been opened', "pt": 'Seu processo foi aberto', "es": 'Su caso ha sido abierto'},
    ...
    "notify.task_delivered": {"en": "{person} delivered a file for '{task}'", "pt": "{person} entregou um arquivo para '{task}'", "es": "{person} entregó un archivo para '{task}'"},
    ...
    "notify.support_ticket_created": {"en": 'New support ticket: {subject}', "pt": 'Nova solicitação de suporte: {subject}', "es": 'Nuevo ticket de soporte: {subject}'},
    ...
    "notify.data_request_raised": {"en": '{kind} request from {person}', "pt": 'Solicitação de {kind} de {person}', "es": 'Solicitud de {kind} de {person}'},
    "notify.data_request_status": {"en": 'Your {kind} request is {status}', "pt": 'Seu solicitação de {kind} está {status}', "es": 'Su solicitud de {kind} está {status}'},
    ...
    "status.waiting_for_review": {
        "en": "Waiting for review", "pt": "Aguardando análise",
        "es": "Esperando revisión"},

    # The subscription screen's own copy (items A1 and A2).
    "plan.starter.tagline": {"en": "For solo consultants opening their first workspace.", "pt": "Para consultores autônomos abrindo seu primeiro espaço de trabalho.", "es": "Para consultores independientes que abren su primer espacio de trabajo."},
    "plan.starter.feature1": {"en": "1 consultant seat · Up to 3 partners", "pt": "1 lugar de consultor · Até 3 parceiros", "es": "1 plaza de consultor · Hasta 3 socios"},
    "plan.starter.feature2": {"en": "Up to 25 active cases", "pt": "Até 25 casos ativos", "es": "Hasta 25 casos activos"},
    "plan.starter.feature3": {"en": "Client request queue and document centre", "pt": "Fila de solicitações e central de documentos", "es": "Cola de solicitudes y centro de documentos"},
    "plan.starter.feature4": {"en": "Email support within 2 business days", "pt": "Suporte por e-mail em até 2 dias úteis", "es": "Soporte por correo en un máximo de 2 días hábiles"},
    "plan.professional.tagline": {"en": "For growing practices with a partner network.", "pt": "Para escritórios em crescimento com rede de parceiros.", "es": "Para despachos en crecimiento con red de socios."},
    "plan.professional.feature1": {"en": "5 consultant seats · Up to 15 partners", "pt": "5 lugares de consultor · Até 15 parceiros", "es": "5 plazas de consultor · Hasta 15 socios"},
    "plan.professional.feature2": {"en": "Unlimited cases", "pt": "Casos ilimitados", "es": "Casos ilimitados"},
    "plan.professional.feature3": {"en": "AI document review and form drafting", "pt": "Revisão de documentos por IA e preenchimento de formulários", "es": "Revisión de documentos con IA y redacción de formularios"},
    "plan.professional.feature4": {"en": "Partner task delegation and deliverables", "pt": "Delegação de tarefas a parceiros e entregas", "es": "Delegación de tareas a socios y entregas"},
    "plan.professional.feature5": {"en": "Priority support within 4 hours", "pt": "Suporte prioritário em até 4 horas", "es": "Soporte prioritario en un máximo de 4 horas"},
    "plan.enterprise.tagline": {"en": "For multi-office firms with compliance needs.", "pt": "Para empresas com vários escritórios e exigências de conformidade.", "es": "Para firmas con varias oficinas y necesidades de cumplimiento."},
    "plan.enterprise.feature1": {"en": "Unlimited consultant seats · Unlimited partners", "pt": "Lugares de consultor ilimitados · Parceiros ilimitados", "es": "Plazas de consultor ilimitadas · Socios ilimitados"},
    "plan.enterprise.feature2": {"en": "Everything in Professional", "pt": "Tudo do plano Professional", "es": "Todo lo del plan Professional"},
    "plan.enterprise.feature3": {"en": "Multi-office workspaces and audit trail", "pt": "Espaços para vários escritórios e trilha de auditoria", "es": "Espacios para varias oficinas y registro de auditoría"},
    "plan.enterprise.feature4": {"en": "Custom data retention and SSO", "pt": "Retenção de dados personalizada e SSO", "es": "Retención de datos personalizada y SSO"},
    "plan.enterprise.feature5": {"en": "Dedicated success manager", "pt": "Gerente de sucesso dedicado", "es": "Gerente de éxito dedicado"},

    # The consent screen and the short legal summaries (items A1, A2).
    "consent.data_processing.title": {"en": "Data Processing Consent", "pt": "Consentimento para tratamento de dados", "es": "Consentimiento para el tratamiento de datos"},
    "consent.data_processing.description": {"en": "To handle your case, WebImove needs your consent to collect, store and process your personal documents in accordance with GDPR. Your data is encrypted and only accessible to your assigned consultant.", "pt": "Para cuidar do seu caso, a WebImove precisa do seu consentimento para coletar, armazenar e tratar seus documentos pessoais conforme o GDPR. Seus dados são criptografados e só ficam acessíveis ao consultor responsável por você.", "es": "Para gestionar su caso, WebImove necesita su consentimiento para recopilar, almacenar y tratar sus documentos personales conforme al RGPD. Sus datos están cifrados y solo son accesibles para el consultor asignado."},
    "consent.data_processing.item_identity": {"en": "Collection and storage of identity documents", "pt": "Coleta e armazenamento de documentos de identidade", "es": "Recopilación y almacenamiento de documentos de identidad"},
    "consent.data_processing.item_authorities": {"en": "Sharing data with the relevant authorities", "pt": "Compartilhamento de dados com as autoridades competentes", "es": "Compartición de datos con las autoridades competentes"},
    "consent.data_processing.item_sensitive": {"en": "Processing sensitive data for your case", "pt": "Tratamento de dados sensíveis para o seu caso", "es": "Tratamiento de datos sensibles para su caso"},
    "legal.privacy.title": {"en": "Privacy Policy", "pt": "Política de Privacidade", "es": "Política de Privacidad"},
    "legal.privacy.updated": {"en": "Last updated: April 2026", "pt": "Última atualização: abril de 2026", "es": "Última actualización: abril de 2026"},
    "legal.privacy.s1": {"en": "We respect your privacy. WebImove collects only the data needed to handle your case - your location, account details, and submitted documents.", "pt": "Respeitamos sua privacidade. A WebImove coleta apenas os dados necessários para cuidar do seu caso: sua localização, os dados da conta e os documentos enviados.", "es": "Respetamos su privacidad. WebImove recopila únicamente los datos necesarios para gestionar su caso: su ubicación, los datos de la cuenta y los documentos enviados."},
    "legal.privacy.s2": {"en": "We never sell your personal information to third parties. You can request a copy of your data or delete your account at any time from Privacy & Security settings.", "pt": "Nunca vendemos suas informações pessoais a terceiros. Você pode pedir uma cópia dos seus dados ou apagar sua conta a qualquer momento em Privacidade e Segurança.", "es": "Nunca vendemos su información personal a terceros. Puede solicitar una copia de sus datos o eliminar su cuenta en cualquier momento desde Privacidad y Seguridad."},
    "legal.privacy.s3": {"en": "Your data is stored securely in encrypted databases isolated per organization.", "pt": "Seus dados ficam guardados com segurança em bancos de dados criptografados e isolados por organização.", "es": "Sus datos se guardan de forma segura en bases de datos cifradas y aisladas por organización."},
    "legal.terms.title": {"en": "Terms of Service", "pt": "Termos de Serviço", "es": "Términos de Servicio"},
    "legal.terms.updated": {"en": "Effective April 2026", "pt": "Em vigor desde abril de 2026", "es": "En vigor desde abril de 2026"},
    "legal.terms.s1": {"en": "By using WebImove you agree to submit documents and case information in good faith. Services shown in the app are provided by licensed consultants and subject to availability.", "pt": "Ao usar a WebImove você concorda em enviar documentos e informações do caso de boa-fé. Os serviços exibidos no aplicativo são prestados por consultores licenciados e estão sujeitos a disponibilidade.", "es": "Al usar WebImove acepta enviar documentos e información del caso de buena fe. Los servicios mostrados en el aplicativo los prestan consultores licenciados y están sujetos a disponibilidad."},
    "legal.terms.s2": {"en": "You are responsible for the accuracy of any information you submit and for keeping your account credentials secure. We may update these terms periodically and will notify you of material changes.", "pt": "Você é responsável pela exatidão das informações que enviar e por manter suas credenciais em segurança. Podemos atualizar estes termos periodicamente e avisaremos sobre mudanças relevantes.", "es": "Usted es responsable de la exactitud de la información que envíe y de mantener seguras sus credenciales. Podemos actualizar estos términos periódicamente y le avisaremos de los cambios relevantes."},
    "legal.terms.s3": {"en": "We never sell your personal information to third parties. You can request a copy of your data or delete your account at any time.", "pt": "Nunca vendemos suas informações pessoais a terceiros. Você pode pedir uma cópia dos seus dados ou apagar sua conta a qualquer momento.", "es": "Nunca vendemos su información personal a terceros. Puede solicitar una copia de sus datos o eliminar su cuenta en cualquier momento."},
    "legal.terms.s4": {"en": "Misuse of system services or fraudulent activity may result in account suspension.", "pt": "O uso indevido dos serviços ou atividade fraudulenta pode levar à suspensão da conta.", "es": "El uso indebido de los servicios o la actividad fraudulenta puede llevar a la suspensión de la cuenta."},
}
